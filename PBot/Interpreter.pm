...
sub interpret {
  ...
  if ($keyword !~ /^(?:factrem|forget|set|factdel|factadd|add|factfind|find|factshow|show|forget|factdel|factset|factchange|change|msg|tell|cc|eval|u|udict|ud|actiontrigger|urban|perl|spinach|lie)$/) {
    $keyword =~ s/(\w+)([?!.]+)$/$1/;
